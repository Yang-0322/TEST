...
def compute_jaccard_distance(features=None, cam_labels=None, epoch=None, args=None):
    ...
    # 95.4 96.3 Market1501 94.9 95.5 QiuxiuUnoccluded 92.8 94.6 Qiuxiu_bs64 92.9 95.2 Qiuxiu_occlusion 94.9 96.6 market_occlusion
    # k1, k2 = 30, 6
    # ckrnns, k1_intra, k1_inter = True, 5, 20
    # clqe, k2_intra, k2_inter = True, 2, 4
    
    # 95.3 96.8 Market1501 94.7 95.5 QiuxiuUnoccluded 92.9 94.8 Qiuxiu_bs64 93.6 95.0 Qiuxiu_occlusion 94.8 96.5 market_occlusion
    # k1, k2 = 30, 5
    # ckrnns, k1_intra, k1_inter = True, 5, 20
    # clqe, k2_intra, k2_inter = True, 2, 3

    # 93.6 95.1 Qiuxiu_occlusion 94.9 96.7 market_occlusion
    k1, k2 = 30, 5
    ckrnns, k1_intra, k1_inter = True, 5, 22
    clqe, k2_intra, k2_inter = True, 2, 4

    # 94.9 96.7 market_occlusion
    # k1, k2 = 40, 6
    # ckrnns, k1_intra, k1_inter = True, 5, 30
    # clqe, k2_intra, k2_inter = True, 2, 6
    
    # 95.0 97.1 Market1501 94.4 95.2 QiuxiuUnoccluded 92.5 94.5 Qiuxiu_bs64 92.9 95.2 Qiuxiu_occlusion 94.6 96.6 market_occlusion
    # k1, k2 = 50, 6
    # ckrnns, k1_intra, k1_inter = True, 10, 20
    # clqe, k2_intra, k2_inter = True, 1, 2
